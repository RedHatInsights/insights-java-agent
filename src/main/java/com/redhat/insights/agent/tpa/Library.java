...
public class Library extends Component implements Comparable<Library> {
  ...
  @JsonIgnore public Library parent = null;

  @JsonIgnore public boolean isUsed = false;

  @JsonIgnore public String jar = null;

  @JsonIgnore public String path = null;

  @JsonIgnore public int classesUsed = 0;
  ...
  public void parsePath(String fullpath) {
    ...
    try {
      setPurl(
          new PackageURL("maven", this.getGroup(), this.getName(), this.getVersion(), null, null));
    } catch (Exception e) {
      // continue
    }
  }
  ...
  public String toString() {
    ...
    return "Library"
        ...
        + path
        + "\n    md5      | "
        + hashes.get(0).getValue()
        + "\n    sha1     | "
        + hashes.get(1).getValue()
        + "\n    maven    | "
        + "https://search.maven.org/search?q=1:"
        + hashes.get(1).getValue();
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof Library) {
      ...
      return (this.getName() + this.getVersion() + this.getGroup())
          .equals(that.getName() + that.getVersion() + that.getGroup());
    } else {
      return false;
    }
  }
